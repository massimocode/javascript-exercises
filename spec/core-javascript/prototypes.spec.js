...
describe("Prototype", () => {
  ...
  describe("SportsCar prototype", () => {
    ...
    beforeEach(() => {
      ...
      sportsCarPrototypeBody = utils.removeInstrumentation(
        prototypes.SportsCar.toString()
      );
    });
  ...
  describe("When creating a SportsCar", () => {
    ...
    it("The accelerate method should be on the prototype", () => {
      expect(sportsCar.accelerate).to.equal(
        prototypes.SportsCar.prototype.accelerate
      );
    });
    ...
    describe("When accelerating", () => {
      ...
      it("It should call the Car prototype's accelerate method", () => {
        expect(prototypes.Car.prototype.accelerate).to.have.been.calledOn(
          sportsCar
        );
      });
