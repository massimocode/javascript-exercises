...
describe('Errors', function () {
    ...
    describe('Create dictionary of values', () => {
        ...
        describe('When creating a dictionary from an array containing duplicate keys', () => {
            ...
            it('It should throw an error', () => {
                expect(() => errors.createDictionary(keyValuePairs)).to.throw(Error, 'You cannot provide duplicate keys');
            });
        });
    });
    ...
    describe('Validating customers', () => {
        ...
        describe('When validating a valid customer', () => {
            ...
            beforeEach(() => {
                validationResult = errors.isCustomerValid(validateCustomer, validCustomer);
            });
        ...
        describe('When validating a valid customer', () => {
            ...
            beforeEach(() => {
                validationResult = errors.isCustomerValid(validateCustomer, invalidCustomer);
            });
