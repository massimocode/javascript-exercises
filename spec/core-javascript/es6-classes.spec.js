...
describe('ES6 Classes', () => {
    ...
    describe('SportsCar class', () => {
        ...
        beforeEach(() => {
            ...
            sportsCarClassBody = utils.removeInstrumentation(classes.SportsCar.toString());
        });
    ...
    describe('When creating a SportsCar', () => {
        ...
        it('The accelerate method should be on the prototype', () => {
            expect(sportsCar.accelerate).to.equal(classes.SportsCar.prototype.accelerate);
        });
        ...
        describe('When accelerating', () => {
            ...
            it('It should call the Car prototype\'s accelerate method', () => {
                expect(classes.Car.prototype.accelerate).to.have.been.calledOn(sportsCar);
            });
