...
describe("Functions", function() {
  ...
  describe("Get function that returns the given value", function() {
    ...
    it("Given an object, should return a function that returns the given object", function() {
      var objectToReturn = {};
      var result = functions.getFunctionThatReturnsTheGivenValue(
        objectToReturn
      );
  ...
  describe("Applying functions", () => {
    describe("Converting arguments to a real array", () => {
      ...
      beforeEach(() => {
        ...
        arg2 = "Hello";
        arg3 = 123;
        result = functions.returnArgumentsAsRealArrayUsingApply(
          arg1,
          arg2,
          arg3
        );
  ...
  describe("Calling functions", () => {
    describe("Converting arguments to a real array", () => {
      ...
      beforeEach(() => {
        ...
        arg2 = "Hello";
        arg3 = 123;
        result = functions.returnArgumentsAsRealArrayUsingCall(
          arg1,
          arg2,
          arg3
        );
  ...
  describe("Invoking a function with context and arguments", () => {
    describe("Given 3 arguments", () => {
      ...
      beforeEach(() => {
        ...
        arg2 = { id: 2 };
        arg3 = { id: 3 };
        functions.callGivenFunctionWithGivenContextAndArguments(
          spyFunction,
          context,
          arg1,
          arg2,
    ...
    describe("Given 5 arguments", () => {
      ...
      it("It should call the supplied function with the given arguments", () => {
        expect(spyFunction).to.have.been.calledWithExactly(
          arg1,
          arg2,
          arg3,
          arg4,
  ...
  describe("Returning a function with context and a bound argument and calling it", () => {
    ...
    beforeEach(() => {
      ...
      context = {};
      argument = { id: 1 };
      let returnedFunction = functions.returnAFunctionThatIsBoundToTheGivenContextAndArgument(
        spyFunction,
        context,
        argument
      );
  ...
  describe("Returning a function with context and several bound arguments and calling it", () => {
    describe("Given 3 arguments", () => {
      ...
      beforeEach(() => {
        ...
        arg2 = { id: 2 };
        arg3 = { id: 3 };
        let returnedFunction = functions.returnAFunctionThatIsBoundToTheGivenContextAndArguments(
          spyFunction,
          context,
          arg1,
          arg2,
    ...
    describe("Counting nodes without recursion", () => {
      ...
      describe("The function", () => {
        ...
        beforeEach(() => {
          ...
          functions.countNodesWithoutFunctionRecursion({
            nodes: [],
            action: () => {}
          });
          functionBody = utils.removeInstrumentation(
            functions.countNodesWithoutFunctionRecursion.toString()
          );
        });

        it("It should not call itself", () => {
          let numberOfTimesFunctionNameUsed = functionBody.match(
            /countNodesWithoutFunctionRecursion/g
          );
