...
describe("Returns", function() {
  ...
  describe("Return arguments flipped", function() {
    ...
    it('Given "a", "b", "c", "d" it should return ["d", c", "b", "a"]', function() {
      expect(returns.returnArgumentsFlipped("a", "b", "c", "d")).to.deep.equal([
        "d",
        "c",
        "b",
        "a"
    ...
    it("Given three objects, it should return them in reverse order", function() {
      let arg1 = {},
        ...
        arg5 = {};
      expect(
        returns.returnArgumentsFlipped(arg1, arg2, arg3, arg4, arg5)
      ).to.deep.equal([arg5, arg4, arg3, arg2, arg1]);
    });
  });
