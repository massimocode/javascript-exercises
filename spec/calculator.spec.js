    ...
    describe('Given a new calculator', function () {
        ...
        describe('When adding 5', function () {
            ...
            describe('When dividing by 0', function () {
                ...
                describe('When adding 1', function () {
                    ...
                    it('It should report the history as expected', function () {
                        expect(calculator.getHistory()).to.deep.equal(["ADD 5", "DIVIDE 0", "ADD 1"]);
                    });
                });
                ...
                describe('When subtracting 1', function () {
                    ...
                    it('It should report the history as expected', function () {
                        expect(calculator.getHistory()).to.deep.equal(["ADD 5", "DIVIDE 0", "SUBTRACT 1"]);
                    });
                });
                ...
                describe('When multiplying by 2', function () {
                    ...
                    it('It should report the history as expected', function () {
                        expect(calculator.getHistory()).to.deep.equal(["ADD 5", "DIVIDE 0", "MULTIPLY 2"]);
                    });
                });
                ...
                describe('When dividing by 2', function () {
                    ...
                    it('It should report the history as expected', function () {
                        expect(calculator.getHistory()).to.deep.equal(["ADD 5", "DIVIDE 0", "DIVIDE 2"]);
                    });
                });
            });
        ...
        describe('When subtracting 7', function () {
            ...
            describe('When multiplying by 8', function () {
                ...
                it('It should report the history as expected', function () {
                    expect(calculator.getHistory()).to.deep.equal(["SUBTRACT 7", "MULTIPLY 8"]);
                });
            });
            ...
            describe('When dividing by 2', function () {
                ...
                it('It should report the history as expected', function () {
                    expect(calculator.getHistory()).to.deep.equal(["SUBTRACT 7", "DIVIDE 2"]);
                });
            });
            ...
            describe('When multiplied to the power of 3', function () {
                ...
                it('It should report the history as expected', function () {
                    expect(calculator.getHistory()).to.deep.equal(["SUBTRACT 7", "POWER 3"]);
                });
            });
            ...
            describe('When dividing by 0', function () {
                ...
                describe('When adding 1', function () {
                    ...
                    it('It should report the history as expected', function () {
                        expect(calculator.getHistory()).to.deep.equal(["SUBTRACT 7", "DIVIDE 0", "ADD 1"]);
                    });
                });
                ...
                describe('When dividing by 2', function () {
                    ...
                    it('It should report the history as expected', function () {
                        expect(calculator.getHistory()).to.deep.equal(["SUBTRACT 7", "DIVIDE 0", "DIVIDE 2"]);
                    });
                });
            });
        ...
        describe('When dividing by 0', function () {
            ...
            describe('When subtracting 1', function () {
                ...
                it('It should report the history as expected', function () {
                    expect(calculator.getHistory()).to.deep.equal(["DIVIDE 0", "SUBTRACT 1"]);
                });
            });
            ...
            describe('When multiplying by 2', function () {
                ...
                it('It should report the history as expected', function () {
                    expect(calculator.getHistory()).to.deep.equal(["DIVIDE 0", "MULTIPLY 2"]);
                });
            });
            ...
            describe('When dividing by 2', function () {
                ...
                it('It should report the history as expected', function () {
                    expect(calculator.getHistory()).to.deep.equal(["DIVIDE 0", "DIVIDE 2"]);
                });
            });
