...
describe('Strings', function () {
    ...
    describe('Replace', function () {
        it('Given "Hello World!", "World", "Earth" it should return "Hello Earth!"', function () {
            expect(strings.replace("Hello World!", "World", "Earth")).to.equal('Hello Earth!');
        });
        
        it('Given "Hello World!", "world", "Earth" it should return "Hello World!"', function () {
            expect(strings.replace("Hello World!", "world", "Earth")).to.equal('Hello World!');
        });
        
        it('Given "Hello World!", "o", "!" it should return "Hell! W!rld!"', function () {
            expect(strings.replace("Hello World!", "o", "!")).to.equal('Hell! W!rld!');
        });
        
        xit('Could add more tests for regular expression edge cases');
    });
    
    describe('Substring by start and length', function () {
        it('Given "Hello World!" 0, 5 it should return "Hello"', function () {
            expect(strings.substringByStartAndLength('Hello World!', 0, 5)).to.equal('Hello');
        });
        
        it('Given "Hello World!" 6, 5 it should return "World"', function () {
            expect(strings.substringByStartAndLength('Hello World!', 6, 5)).to.equal('World');
        });
    ...
    describe('Substring by start and end', function () {
        it('Given "Hello World!" 0, 5 it should return "Hello"', function () {
            expect(strings.substringByStartAndEnd('Hello World!', 0, 5)).to.equal('Hello');
        });
        
        it('Given "Hello World!" 6, 11 it should return "World"', function () {
            expect(strings.substringByStartAndEnd('Hello World!', 6, 11)).to.equal('World');
        });
    ...
    describe('Splitting strings', function () {
        it('Given "Hello World!" " " it should return ["Hello", "World!"]', function () {
            expect(strings.split('Hello World!', " ")).to.deep.equal(['Hello', 'World!']);
        });
        
        it('Given "Hello World!" "o" it should return ["Hell", " W", "rld!"]', function () {
            expect(strings.split('Hello World!', "o")).to.deep.equal(["Hell", " W", "rld!"]);
        });
        
        it('Given "1,2,3,4,5" "," it should return ["1", "2", "3", "4", "5"]', function () {
            expect(strings.split("1,2,3,4,5", ",")).to.deep.equal(["1", "2", "3", "4", "5"]);
        });
    });
    ...
    describe('Joining arrays into strings', function () {
        ...
        it('Given ["Hell", " W", "rld!"] and "o" it should return "Hello World!"', function () {
            expect(strings.join(["Hell", " W", "rld!"], "o")).to.equal("Hello World!");
        });
        
        it('Given ["1", "2", "3", "4", "5"] and "," it should return "1,2,3,4,5"', function () {
            expect(strings.join(["1", "2", "3", "4", "5"], ",")).to.equal("1,2,3,4,5");
        });
    });
